...
<body>
    ...
    <h4 class="text-center">
        <!-- <?php echo $titulo; ?> de <?php echo $data; ?> -->
       
Estatística das Candidaturas  
<!-- <?php echo $data?>  -->
de <?php echo $data_inicio  ?>
    </h4>
    <br>
        ...
        <tbody>
            ...
            foreach ($cursos as $curso) : ?>
                ...
                <tr>
                    ...
                    if ($data == "Todos") {
                        $MporC = Candidatura::where([['vc_nomeCurso', $curso->vc_nomeCurso], ['vc_genero', '=', "Masculino"]])->whereDate('created_at', $data_inicio)->count();
                        $FporC = Candidatura::where([['vc_nomeCurso', $curso->vc_nomeCurso], ['vc_genero', '=', "Feminino"]])->whereDate('created_at', $data_inicio)->count();
                    } else {
                        $MporC = Candidatura::where([['vc_anoLectivo', $data], ['vc_nomeCurso', $curso->vc_nomeCurso], ['vc_genero', '=', "Masculino"]])->whereDate('created_at', $data_inicio)->count();
                        $FporC = Candidatura::where([['vc_anoLectivo', $data], ['vc_nomeCurso', $curso->vc_nomeCurso], ['vc_genero', '=', "Feminino"]])->whereDate('created_at', $data_inicio)->count();
                    }
                    ?>
