        ...
        <tbody>
            ...
            foreach ($cursos as $curso) : ?>
                ...
                <tr>
                    ...
                    if ($data == "Todos") {
                        if(!isset($dia)){
                        $DporC = DB::table('matriculas')->join('cursos', 'matriculas.it_idCurso', '=', 'cursos.id')->join('alunnos', 'matriculas.it_idAluno', '=', 'alunnos.id')->where([['cursos.vc_nomeCurso', $curso->vc_nomeCurso], ['alunnos.vc_dificiencia', '=', "Sim"]])->count();
                        $MporC = DB::table('matriculas')->join('cursos', 'matriculas.it_idCurso', '=', 'cursos.id')->join('alunnos', 'matriculas.it_idAluno', '=', 'alunnos.id')->where([['cursos.vc_nomeCurso', $curso->vc_nomeCurso], ['alunnos.vc_genero', '=', "Masculino"]])->count();
                        $FporC = DB::table('matriculas')->join('cursos', 'matriculas.it_idCurso', '=', 'cursos.id')->join('alunnos', 'matriculas.it_idAluno', '=', 'alunnos.id')->where([['cursos.vc_nomeCurso', $curso->vc_nomeCurso], ['alunnos.vc_genero', '=', "Feminino"]])->count();
                        }else{
                        ...
                        if(!isset($dia)){
                        $DporC = DB::table('matriculas')->join('cursos', 'matriculas.it_idCurso', '=', 'cursos.id')->join('alunnos', 'matriculas.it_idAluno', '=', 'alunnos.id')->where([['matriculas.vc_anoLectivo', $data], ['cursos.vc_nomeCurso', $curso->vc_nomeCurso], ['alunnos.vc_dificiencia', '=', "Sim"]])->count();
                        $MporC = DB::table('matriculas')->join('cursos', 'matriculas.it_idCurso', '=', 'cursos.id')->join('alunnos', 'matriculas.it_idAluno', '=', 'alunnos.id')->where([['matriculas.vc_anoLectivo', $data], ['cursos.vc_nomeCurso', $curso->vc_nomeCurso], ['alunnos.vc_genero', '=', "Masculino"]])->count();
                        $FporC = DB::table('matriculas')->join('cursos', 'matriculas.it_idCurso', '=', 'cursos.id')->join('alunnos', 'matriculas.it_idAluno', '=', 'alunnos.id')->where([['matriculas.vc_anoLectivo', $data], ['cursos.vc_nomeCurso', $curso->vc_nomeCurso], ['alunnos.vc_genero', '=', "Feminino"]])->count();
                    }else{
